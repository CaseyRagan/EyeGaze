...
import { Monitor, RotateCcw, Sliders, Stethoscope, Sun, Volume2, X } from 'lucide-react';
    ...
    <div className="fixed inset-0 z-50 flex justify-end bg-[rgba(44,50,48,0.25)]" onClick={onClose}>
      ...
      >
        ...
        <div className="px-6 py-5 space-y-8">
          ...
          <Section title="Something not right?" icon={Stethoscope}>
            <p className="text-xs text-ink-soft leading-relaxed">
              Shows exactly what the tracker is seeing — camera, distance, head pose, calibration —
              with a copy button. Far quicker to read than to describe.
            </p>
            <button
